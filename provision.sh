...
sudo dd if=tmp/deploy/images/sam9x60ek-sd-frogsboro/frogsboro-headless-image-sam9x60ek-sd-frogsboro.wic of=${DEVICE} bs=4M
sudo mount ${DEVICE}3 ${FROG_MNT}
